...
<template>
  <div class="comment-container vp-raw">
    ...
    <link
      rel="stylesheet"
      href="https://jsd-proxy.ygxz.in/npm/lightgallery@2.1.8/css/lightgallery.css"
      integrity="sha384-U8ohOXEVyF0NGY2LQnH83V4wGxOmFhim4U5xhfE/WDCHdPO2iUKPPYkhpDl9U/Yf"
      crossorigin="anonymous"
    />
    <component
      :is="'script'"
      src="https://jsd-proxy.ygxz.in/npm/lightgallery@2.1.8/lightgallery.min.js"
    ...
    <component
      :is="'script'"
      src="https://jsd-proxy.ygxz.in/npm/twikoo@1.6.44/dist/twikoo.min.js"
      crossorigin="anonymous"
      ref="twikooJs"
    ></component>
  </div>
